...
replace gioui.org => github.com/inkeliz/gio v0.0.0-20230708131042-c550dbd57c4d

replace gioui.org/cmd => github.com/inkeliz/gio-cmd v0.0.0-20230710155951-f9a8bfc4207e
